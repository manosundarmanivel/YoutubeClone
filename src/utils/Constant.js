const API_KEY = "AIzaSyC7wprlfL3wZzDjIcQfpvnjWmF06Xa0I88"
...
export const YOUTUBE_LIVE_API = "https://youtube.googleapis.com/youtube/v3/search?part=snippet&eventType=live&maxResults=25&q=news&type=video&key="+API_KEY
export const YOUTUBE_LIVE_DETAILS = "https://www.googleapis.com/youtube/v3/videos?part=liveStreamingDetails,snippet&key="+API_KEY+"&id="
export const YOUTUBE_LIVE_COMMENT ="https://www.googleapis.com/youtube/v3/liveChat/messages?part=snippet,authorDetails&maxResults=2000&key="+API_KEY+"&liveChatId="
